...
$Host.UI.RawUI.WindowTitle = 'ROLLBACK Zona Lateral Texto Llaves - Sistema FCEA'
...
Line
Write-Host "  ROLLBACK: Zona del tablero - aclaracion en Laterales" -ForegroundColor Yellow

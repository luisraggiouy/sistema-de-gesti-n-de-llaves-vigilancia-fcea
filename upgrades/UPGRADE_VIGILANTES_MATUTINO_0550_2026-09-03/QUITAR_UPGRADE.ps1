...
$Host.UI.RawUI.WindowTitle = 'ROLLBACK Vigilantes Matutino 05:50 - Sistema FCEA'
...
Line
Write-Host "  ROLLBACK: Vigilantes del Matutino visibles desde las 05:50" -ForegroundColor Yellow

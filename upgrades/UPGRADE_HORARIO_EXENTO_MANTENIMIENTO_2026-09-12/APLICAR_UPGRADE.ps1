# =============================================================
# APLICAR_UPGRADE.ps1
# UPGRADE: "Horario - Mantenimiento exento 24 hs"
# Fecha: 2026-09-12
#
# QUE CAMBIA (Terminal de Usuario A/B):
#   Se agrega el departamento/seccion "Mantenimiento" a la lista de
#   Personal TAS EXENTO TOTAL del horario restringido (pueden solicitar
#   llaves a cualquier hora, 24 hs). Antes estaban exentos 24 hs:
...
$Host.UI.RawUI.WindowTitle = 'UPGRADE Horario Mantenimiento 24h - Sistema FCEA'
...
Line
Write-Host "  UPGRADE: Mantenimiento exento 24 hs" -ForegroundColor Yellow
...
Write-Host "   A) MANTENIMIENTO a cualquier hora (incluso de madrugada):" -ForegroundColor Green
Write-Host "      Personal TAS con departamento 'Mantenimiento' -> debe dejar enviar" -ForegroundColor Green

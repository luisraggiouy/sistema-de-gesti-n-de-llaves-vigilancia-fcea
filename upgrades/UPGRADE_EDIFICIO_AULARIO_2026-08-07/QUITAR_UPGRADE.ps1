...
# Upgrade: Nuevo edificio "Aulario" en Gestion de Llaves (2026-08-07)
# Monitor de Vigilancia (y opcionalmente Terminal A / Terminal B)
# =============================================================
$ErrorActionPreference = 'Stop'
$Host.UI.RawUI.WindowTitle = 'ROLLBACK Edificio Aulario - Sistema FCEA'

...
$Host.UI.RawUI.WindowTitle = 'ROLLBACK Bloqueo Nocturno Botones - Sistema FCEA'
...
Line
Write-Host "  ROLLBACK: Bloqueo nocturno de botones (22:00 - 06:00)" -ForegroundColor Yellow

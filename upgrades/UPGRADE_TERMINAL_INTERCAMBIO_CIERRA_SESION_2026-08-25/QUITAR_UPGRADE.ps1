...
$Host.UI.RawUI.WindowTitle = 'ROLLBACK Intercambio Cierra Sesion - Sistema FCEA'
...
Line
Write-Host "  ROLLBACK: Intercambio cierra sesion / limpia Terminal" -ForegroundColor Yellow

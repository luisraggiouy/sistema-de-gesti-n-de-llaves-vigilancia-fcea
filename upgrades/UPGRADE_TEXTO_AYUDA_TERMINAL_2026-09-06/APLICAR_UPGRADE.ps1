# =============================================================
# APLICAR_UPGRADE.ps1
# UPGRADE: "Texto de ayuda en pantalla de identificacion"
...
#
# NOVEDAD: debajo del titulo "Identificarse con su numero de celular
# o e-mail" ahora aparece un renglon de ayuda:
#   "Haga click sobre su nombre una vez que lo vea en la pantalla,
#    para solicitar la/s llaves"
# y el placeholder de la caja de texto ahora dice:
#   "Ingrese aqui su numero de celular o email..."
#
# ESTE UPGRADE VA EN: Terminal A y Terminal B (repetir en cada una).
#
# ROLLBACK: usar 2-DESHACER_TEXTO_AYUDA_ROLLBACK.bat (restaura el ultimo backup).
# =============================================================
$ErrorActionPreference = 'Stop'
$Host.UI.RawUI.WindowTitle = 'UPGRADE Texto Ayuda Terminal - Sistema FCEA'
...
Line
Write-Host "  UPGRADE: Texto de ayuda en pantalla de identificacion" -ForegroundColor Yellow
...
Write-Host "  Debajo del titulo debe verse el renglon:" -ForegroundColor Green
Write-Host "  'Haga click sobre su nombre una vez que lo vea en la pantalla...'" -ForegroundColor Green

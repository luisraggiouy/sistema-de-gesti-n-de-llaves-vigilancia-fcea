...
$Host.UI.RawUI.WindowTitle = 'ROLLBACK Terminal sin contador + Eliminar solicitud - Sistema FCEA'
...
Line
Write-Host "  ROLLBACK: Terminal sin contador + Eliminar solicitud" -ForegroundColor Yellow

...
# UPGRADE (FIX v2): "Bloqueo nocturno de botones del Monitor"
# Fecha: 2026-08-25
#
# QUE HACE:
...
$Host.UI.RawUI.WindowTitle = 'ROLLBACK Fix Tooltip Bloqueo Nocturno - Sistema FCEA'
...
Line
Write-Host "  ROLLBACK: Fix tooltip / desbloqueo nocturno" -ForegroundColor Yellow

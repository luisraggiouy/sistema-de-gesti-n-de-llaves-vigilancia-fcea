# =============================================================
# APLICAR_UPGRADE.ps1
# UPGRADE: "Cartel de advertencia al confirmar cambios en Configuracion"
#          Monitor de Vigilancia -> pestana Configuracion
# Fecha: 2026-08-07
#
# QUE HACE:
...
#
# NOVEDAD: al tocar "Guardar cambios" o "Restaurar valores" en la
# pestana Configuracion, ahora aparece un cartel de advertencia de
# accion sensible que exige confirmar antes de aplicar el cambio.
#
# ROLLBACK: usar 2-DESHACER_CARTEL_CONFIG_ROLLBACK.bat (restaura el ultimo backup).
# =============================================================
$ErrorActionPreference = 'Stop'
$Host.UI.RawUI.WindowTitle = 'UPGRADE Cartel Confirmar Configuracion - Sistema FCEA'
...
Line
Write-Host "  UPGRADE: Cartel de advertencia al confirmar Configuracion" -ForegroundColor Yellow
...
Write-Host "  Proba en el Monitor: pestana Configuracion." -ForegroundColor Green
Write-Host "   - Toca 'Guardar cambios' o 'Restaurar valores'." -ForegroundColor Green
Write-Host "   - Debe aparecer el cartel de advertencia de accion sensible" -ForegroundColor Green
Write-Host "     antes de aplicar el cambio (Cancelar / Si, aplicar cambios)." -ForegroundColor Green

# UPGRADE — Horario: Electrotecnia exento 24 hs (2026-09-12)

## Qué hace
Agrega el departamento/sección **Electrotecnia** a la lista de **Personal TAS
exento TOTAL del horario restringido**. Es decir, el Personal TAS de
Electrotecnia puede **solicitar llaves a cualquier hora (24 hs)**, igual que
...
2. Abrí la carpeta
   `UPGRADES\UPGRADE_HORARIO_EXENTO_ELECTROTECNIA_2026-09-12`.
...
- **A)** Identificate como **Personal TAS con departamento "Electrotecnia"**,

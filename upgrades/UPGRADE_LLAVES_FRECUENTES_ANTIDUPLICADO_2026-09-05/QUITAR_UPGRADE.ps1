...
$Host.UI.RawUI.WindowTitle = 'ROLLBACK Llaves frecuentes antiduplicado - Sistema FCEA'
...
Line
Write-Host "  ROLLBACK: Llaves frecuentes - antiduplicado" -ForegroundColor Yellow

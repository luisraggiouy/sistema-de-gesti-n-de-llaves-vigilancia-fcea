...
$Host.UI.RawUI.WindowTitle = 'ROLLBACK Terminal Limpia Buscador - Sistema FCEA'
...
Line
Write-Host "  ROLLBACK: Terminal limpia buscador tras solicitar" -ForegroundColor Yellow

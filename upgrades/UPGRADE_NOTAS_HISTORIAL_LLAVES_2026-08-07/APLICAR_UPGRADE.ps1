...
#          Monitor de Vigilancia (buscador historico)
# Fecha: 2026-08-07
#
# QUE HACE:
...
#
# NOVEDAD: en el "Buscador Historico de Llaves", cada registro que
# tenga NOTAS (las que se escribieron mientras la llave estaba en uso)
# ahora las muestra debajo del registro. Si el registro NO tiene notas,
# no aparece nada (no ocupa espacio).
#
# ESTE UPGRADE VA EN: Monitor de Vigilancia (que hace de servidor).
#
# ROLLBACK: usar 2-DESHACER_NOTAS_HISTORIAL_ROLLBACK.bat (restaura el ultimo backup).
# =============================================================
$ErrorActionPreference = 'Stop'
$Host.UI.RawUI.WindowTitle = 'UPGRADE Notas Historial Llaves - Sistema FCEA'
...
Line
Write-Host "  UPGRADE: Notas en el Buscador Historico de Llaves" -ForegroundColor Yellow
...
Write-Host "  Abri el 'Buscador Historico de Llaves': los registros que tengan" -ForegroundColor Green
Write-Host "  notas cargadas ahora las muestran; los que no tienen, no muestran nada." -ForegroundColor Green

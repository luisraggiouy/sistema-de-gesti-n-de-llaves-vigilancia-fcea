...
# UPGRADE: "Notas en el Buscador Historico de Llaves"
# Fecha: 2026-08-07
#
# QUE HACE:
...
$Host.UI.RawUI.WindowTitle = 'ROLLBACK Notas Historial Llaves - Sistema FCEA'
...
Line
Write-Host "  ROLLBACK: Notas en el Buscador Historico de Llaves" -ForegroundColor Yellow

...
# UPGRADE: "Identificarse con el email SIN escribir la @"
# Fecha: 2026-09-03
#
# QUE HACE:
...
$Host.UI.RawUI.WindowTitle = 'ROLLBACK Identificar por Email sin @ - Sistema FCEA'
...
Line
Write-Host "  ROLLBACK: Identificarse con el email SIN escribir la @" -ForegroundColor Yellow

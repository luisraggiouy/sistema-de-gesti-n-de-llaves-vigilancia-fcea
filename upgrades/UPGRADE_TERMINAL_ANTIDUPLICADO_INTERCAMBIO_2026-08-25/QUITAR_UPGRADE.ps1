...
# UPGRADE: "Terminal - evitar duplicados + intercambio en frecuentes"
# Fecha: 2026-08-25
#
# Restaura el ULTIMO backup del dist (dist_backup_<fecha_hora>)
# que dejo el script APLICAR_UPGRADE.ps1. NO toca PocketBase ni datos.
# EJECUTAR en la misma Terminal donde se aplico el upgrade.
# =============================================================
$ErrorActionPreference = 'Stop'
$Host.UI.RawUI.WindowTitle = 'ROLLBACK Terminal Antiduplicado - FCEA'
...
Line
Write-Host "  ROLLBACK: Terminal - antiduplicado + intercambio frecuentes" -ForegroundColor Yellow

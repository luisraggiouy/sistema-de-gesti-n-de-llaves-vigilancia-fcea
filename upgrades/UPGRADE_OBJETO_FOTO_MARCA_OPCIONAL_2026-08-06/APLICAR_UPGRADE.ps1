# =============================================================
# APLICAR_UPGRADE.ps1
# UPGRADE: "Foto de la marca" OPCIONAL + area de foto CUADRADA
#          en "Registrar Objeto Olvidado" (Monitor de Vigilancia)
# Fecha: 2026-08-06
#
# QUE HACE:
...
$Host.UI.RawUI.WindowTitle = 'UPGRADE Foto Marca Opcional - Sistema FCEA'
...
Line
Write-Host "  UPGRADE: Foto de la marca OPCIONAL + area cuadrada" -ForegroundColor Yellow
...
Write-Host "  Proba en el Monitor: Registrar Objeto Olvidado." -ForegroundColor Green
Write-Host "   - 'Foto de la marca' ahora dice (opcional) y NO tiene asterisco." -ForegroundColor Green
Write-Host "   - El area de la foto es CUADRADA." -ForegroundColor Green

...
# UPGRADE: "Terminal - textos registro + campos rojos + auto-scroll"
# Fecha: 2026-09-05
#
...
$Host.UI.RawUI.WindowTitle = 'ROLLBACK Terminal Registro + Auto-scroll - Sistema FCEA'
...
Line
Write-Host "  ROLLBACK: Terminal registro + auto-scroll (2026-09-05)" -ForegroundColor Yellow

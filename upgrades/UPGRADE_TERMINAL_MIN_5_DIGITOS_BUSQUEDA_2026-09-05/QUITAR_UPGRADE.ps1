...
# UPGRADE: "Lista por celular recien al 5to digito (anti-suplantacion)"
# Fecha: 2026-09-05
#
# Restaura el ULTIMO backup del dist (dist_backup_<fecha_hora>)
# que dejo APLICAR_UPGRADE.ps1. NO toca PocketBase. NO borra datos.
# =============================================================
$ErrorActionPreference = 'Stop'
$Host.UI.RawUI.WindowTitle = 'ROLLBACK Busqueda min 5 digitos - Sistema FCEA'
...
Line
Write-Host "  ROLLBACK: Lista por celular recien al 5to digito (2026-09-05)" -ForegroundColor Yellow

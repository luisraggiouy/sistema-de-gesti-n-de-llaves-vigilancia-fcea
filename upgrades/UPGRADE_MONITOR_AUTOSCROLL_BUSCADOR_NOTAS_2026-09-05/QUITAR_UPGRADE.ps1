...
$Host.UI.RawUI.WindowTitle = 'ROLLBACK Autoscroll+Buscador+Notas - Sistema FCEA'
...
Line
Write-Host "  ROLLBACK: Autoscroll 8s + Buscador izquierda + Notas 1 renglon" -ForegroundColor Yellow

...
$Host.UI.RawUI.WindowTitle = 'ROLLBACK Monitor Auto-scroll Encabezado - Sistema FCEA'
...
Line
Write-Host "  ROLLBACK: Monitor auto-scroll al encabezado tras 4s" -ForegroundColor Yellow

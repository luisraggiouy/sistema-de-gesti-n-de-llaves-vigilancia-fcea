...
# UPGRADE: "Boton X para borrar todo el texto de un campo"
# Fecha: 2026-08-08
#
# QUE HACE:
...
$Host.UI.RawUI.WindowTitle = 'ROLLBACK Boton X Limpiar Campos - Sistema FCEA'
...
Line
Write-Host "  ROLLBACK: Boton X para borrar todo el texto de un campo" -ForegroundColor Yellow

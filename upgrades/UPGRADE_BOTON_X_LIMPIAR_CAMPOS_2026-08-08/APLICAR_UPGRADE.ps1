...
#          (campos de carga manual: Gestion de Llaves + Objetos Olvidados)
# Fecha: 2026-08-08
#
# QUE HACE:
...
#
# NOVEDAD: en los campos de texto de carga manual aparece una "X"
# a la derecha (solo cuando hay texto) que borra TODO el contenido
# de un solo click, ademas del backspace habitual. Se aplico en:
#   - Gestion de Llaves (Agregar/Modificar): Nombre y Columna.
#   - Objetos Olvidados (devolucion): Nombre y Cedula del receptor.
# NO se toco ningun buscador ni el resto del sistema.
#
# ESTE UPGRADE VA EN: Monitor de Vigilancia (que hace de servidor).
#
# ROLLBACK: usar 2-DESHACER_BOTON_X_ROLLBACK.bat (restaura el ultimo backup).
# =============================================================
$ErrorActionPreference = 'Stop'
$Host.UI.RawUI.WindowTitle = 'UPGRADE Boton X Limpiar Campos - Sistema FCEA'
...
Line
Write-Host "  UPGRADE: Boton X para borrar todo el texto de un campo" -ForegroundColor Yellow
...
Write-Host "  Proba en 'Gestion de Llaves' (Agregar/Modificar): al escribir en" -ForegroundColor Green
Write-Host "  Nombre o Columna aparece una X a la derecha que borra todo de un click." -ForegroundColor Green
